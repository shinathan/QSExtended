...
**This project is discontinued. A standard loop-based backtester is enough for my needs, while avoiding complexity.**

This is based on the QuantStart [tutorial](http://www.quantstart.com/articles/Event-Driven-Backtesting-with-Python-Part-I/) tutorials and the [book](http://www.quantstart.com/successful-algorithmic-trading-ebook/). The vanilla version had a lot of bugs and didn't even work at all. I have fixed the problems and added some simplifications and extra features. This backtester is currently for US equity only.
