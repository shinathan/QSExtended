...
This project is currently on hold, because I am focussing on the data and trying out vectorized backtesting. You can follow the other project here (link to be inserted).
